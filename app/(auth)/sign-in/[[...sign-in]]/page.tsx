  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      * {
      ...
      .clerk-signin-container .cl-main {
        width: 100% !important;
        max-width: 100% !important;
        padding: 0 !important;
        margin: 0 auto !important;
      ...
      .clerk-signin-container .cl-formContainer {
        width: 100% !important;
        max-width: 100% !important;
        display: flex !important;
        flex-direction: column !important;
      ...
      .clerk-signin-container .cl-form {
        width: 100% !important;
        max-width: 100% !important;
        display: flex !important;
        flex-direction: column !important;
      ...
      .clerk-signin-container .cl-socialButtons {
        width: 100% !important;
        max-width: 100% !important;
      ...
      .clerk-signin-container .cl-footerActionText {
      ...
      .clerk-signin-container .cl-formFieldRow {
        margin-bottom: 20px !important;
        width: 100% !important;
        max-width: 100% !important;
        display: flex !important;
      ...
      .clerk-signin-container .cl-formFieldLabel {
        font-size: 14px !important;
        font-weight: 600 !important;
      ...
      .clerk-signin-container .cl-formFieldError {
      ...
      /* Divider - CENTERED */
      .clerk-signin-container .cl-dividerRow {
      ...
      /* Badge - CENTERED */
      .clerk-signin-container .cl-badge {
      ...
      /* Loading states */
      .clerk-signin-container .cl-spinner {
      ...
      <div className="relative z-10 pt-4 sm:pt-6 lg:pt-8 pb-8 sm:pb-12 px-3 sm:px-4 lg:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-center">
            ...
            {/* Sign In Form - Now centered and fully responsive */}
              ...
              <div className="relative">
                ...
                <div className="relative bg-white/70 backdrop-blur-xl p-0.5 sm:p-1 rounded-2xl sm:rounded-3xl border border-white/50 shadow-xl sm:shadow-2xl">
                  <div className="bg-white rounded-2xl sm:rounded-3xl p-3 sm:p-4 lg:p-6 xl:p-8 shadow-lg overflow-hidden">
                    ...
                    <div className="clerk-signin-container w-full overflow-hidden">
                      <SignIn
                        path="/sign-in"
                        routing="path"
                        signUpUrl="/sign-up"
                    ...
                    {/* Quick Access Info */}
                    <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl border border-emerald-100">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-600">
                            Automatic redirect to your personalized dashboard
                          </p>
                        </div>
                      </div>
                    </div>
